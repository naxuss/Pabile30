...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_3x10(
		...
		LSFT_T(KC_Z), LCTL_T(KC_X), LGUI(KC_C), LALT(KC_V), LT(4,KC_SPC), LT(3,KC_SPC), RALT(KC_B), LT(2,KC_N), RCTL(KC_M), RSFT(KC_SLSH)),
	[1] = LAYOUT_ortho_3x10(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_END, KC_NO, KC_NO, KC_BSPC),
